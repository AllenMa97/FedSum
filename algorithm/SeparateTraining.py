...
def ST_LR(global_model, algorithm_epoch_T, num_clients_K, training_dataloaders):
    # Training process
...
def ST_NN(global_model, algorithm_epoch_T, num_clients_K, training_dataloaders):
    # Training process
    logger.info("Training process")
